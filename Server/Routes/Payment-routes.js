...
import {isLoggedIn,  authorizedRoles, authorizeSubscribers } from "../middlewares/auth_middle.js";
...
router.post('/cancel',isLoggedIn,authorizeSubscribers,cancelSubscription)
